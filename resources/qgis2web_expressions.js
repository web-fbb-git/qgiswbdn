...
function exp_label_FBB_UABTEILUNGEN_abgegriffen_alte_FEUAbteilungen_abgegriffen_alte_FE_2_eval_expression(context) {
    // lower(u_abteilung)

    var feature = context.feature;
    
    if (feature.properties) {
        return fnc_lower([feature.get('u_abteilung') ], context);
    } else {
        return fnc_lower([feature.get('u_abteilung') ], context);
    }
}