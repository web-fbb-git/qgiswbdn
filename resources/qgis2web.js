...
map.getView().fit([1000124.313563, 6728308.313035, 1002800.084365, 6730168.540621], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_FBB_UABTEILUNGEN_abgegriffen_alte_FEUAbteilungen_abgegriffen_alte_FE_2,
    colName: 'abt_ut',
    zoom: 10,
    collapsed: true,
    map: map,
